...
public class ErroDTO implements Serializable {
	...
	public ErroDTO codigo(Integer codigo) {
		this.codigo = codigo;
		return this;
	}
	...
	public ErroDTO mensagem(String mensagem) {
	...
	public ErroDTO ticket(String ticket) {
		this.ticket = ticket;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ErroDTO erro = (ErroDTO) o;
		return Objects.equals(this.codigo, erro.codigo) && Objects.equals(this.mensagem, erro.mensagem)
