...
public class PessoaController {
	...
	@GetMapping("/{id}")
	public PessoaDTO buscarPessoaPeloId(@PathVariable("id") Long id) {				
		return mapper.mapTo(service.buscarPessoaPeloId(id), PessoaDTO.class);
	}
	...
	@Secured({Perfis.ADMINISTRADOR, Perfis.COMISSAO})
	@PutMapping
	public PessoaDTO atualizarPessoa(@RequestBody PessoaDTO pessoa) {				
		return mapper.mapTo(service.atualizarPessoa(mapper.mapTo(pessoa, Pessoa.class)),
				PessoaDTO.class);
	}
